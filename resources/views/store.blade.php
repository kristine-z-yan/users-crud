...
@section('content')
    ...
    <form action="{{route('users.store')}}" method="post">
        ...
        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
            ...
            <input type="text" id="first-name" class="form-control" name="first_name" placeholder="First Name" value="{{old('first_name')}}">
        ...
        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
            ...
            <input type="text" id="last-name" class="form-control" name="last_name" placeholder="Last Name" value="{{old('last_name')}}">
